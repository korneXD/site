      ...
      <div className="flex flex-col gap-4 w-full">
        <div>
          ...
          <p className="text-neutral-400 text-md">
            My services can be viewed in the following points below
          </p>
        </div>
        <div className="flex justify-around flex-row items-start border border-cyan-500 rounded-lg p-2 gap-4">
          <div className="flex flex-col flex-wrap w-full justify-center items-center">
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="size-7 text-cyan-500 stroke-2"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <p className="text-center text-neutral-400 text-md">
              Development and coding a website dreamed up by a client
            </p>
          </div>
          <div className="flex flex-col flex-wrap w-full justify-center items-center">
            <svg
            ...
            <p className="text-center text-neutral-400 text-md">
              Creating a fast, responsive, dynamic website
            </p>
          </div>
          <div className="flex flex-col flex-wrap w-full justify-center items-center">
            <svg
            ...
            <p className="text-center text-neutral-400 text-md">
              Website, domain, database management, commissioning and publishing
            </p>
          </div>
        </div>
      </div>
